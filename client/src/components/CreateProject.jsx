...
// --- 1. DEPLOYMENT FIX: Read VITE_API_URL from Netlify Environment ---
// This ensures we use the live Render backend URL, not localhost.
...
// --- 2. BUG FIX: Step Handlers ---
 // This function ONLY updates the steps array and does not touch the description state.
...
<div className="mb-6 border border-gray-200 p-5 rounded-lg">
 ...
 <textarea
  ...
  value={step}
  rows="3"
// 🛑 BUG FIX: Correctly call the handler with index and value only
